				...
				<div class="col-sm-9">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                           ...
                           <a class="nav-item nav-link" href="category/category.html">Category</a>
                           <a class="nav-item nav-link" href="shoeCollection">Shoes</a>
                           <a class="nav-item nav-link" href="racing boots.html">Racing Boots</a>
                           <a class="nav-item nav-link" href="login">Login</a>
                           <a class="nav-item nav-link last" href="#"><img src="images/search_icon.png"></a>
                           <a class="nav-item nav-link last" href="cart/cart.html"><img src="images/shop_icon.png"></a>
                        </div>
                    </div>
                    </nav>
				</div>
                ...
                <div class="carousel-item active">
					...
					<div class="col-sm-5">
						<div class="banner_taital">
							...
							<a href="product-detail/detail.html"><button class="buy_bt" >Buy Now</button></a>
    		...
    		<!-- <div class="row">
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Shoe name</p>
    					<div class="shoes_icon"><img src="images/shoes-img4.png"></div>Shoe Image
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    						...
    						<div class="right_part">
    							<div class="shoes_price">$ <span style="color: #ff4e5b;">Shoe price</span></div>
    						</div>
    					</div>
    				</div>
    			</div>		
